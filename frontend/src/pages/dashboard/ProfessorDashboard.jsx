...
const sidebarItems = [
  ...
  { label: "Grade Submission", href: "/dashboard/professor/grades", icon: ClipboardCheck },
  { label: "Attendance", href: "/dashboard/professor/attendance", icon: Users },
  { label: "Schedule", href: "/dashboard/professor/schedule", icon: Calendar },
  { label: "Materials", href: "/dashboard/professor/materials", icon: FileText },
]
